...
export default function Backbar({ href, onclick } :  { href?: string, onclick?: any }) {
    ...
    return (
        <div className="mb-5">
            <span className="bg-black/5 hover:bg-red-600 text-red-600 duration-300 hover:text-white w-12 h-12 flex items-center justify-center rounded-lg cursor-pointer" onClick={executeAction}>
